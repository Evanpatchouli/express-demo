...
var formDataToStream = function formDataToStream(form, headersHandler, options) {
  var _ref8 = options || {},
    _ref8$tag = _ref8.tag,
    tag = _ref8$tag === void 0 ? 'form-data-boundary' : _ref8$tag,
    _ref8$size = _ref8.size,
    size = _ref8$size === void 0 ? 25 : _ref8$size,
    _ref8$boundary = _ref8.boundary,
    boundary = _ref8$boundary === void 0 ? tag + '-' + utils.generateString(size, BOUNDARY_ALPHABET) : _ref8$boundary;
  ...
  var parts = Array.from(form.entries()).map(function (_ref9) {
...
var ZlibHeaderTransformStream = /*#__PURE__*/function (_stream__default$defa2) {
  ...
  var _super2 = _createSuper(ZlibHeaderTransformStream);
        ...
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            if (lookup && utils.isAsyncFn(lookup)) {
              lookup = callbackify$1(lookup, function (entry) {
...
Object.entries(HttpStatusCode).forEach(function (_ref11) {
